 ...
 *
 * edit by eulerscheZahl: create smaller replay sizes
 */
@Singleton
public class TinyToggleModule implements Module {
    ...
    @Inject
    TinyToggleModule(GameManager<AbstractPlayer> gameManager) {
