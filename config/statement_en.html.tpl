    ...
    <div class="statement-section statement-rules">
        ...
        <div>
            <div class="statement-rules-content">
                ...
                They can use a triangle to spawn a new unit, kill all opponent units on a given node and add or remove a
    ...
    <div class="statement-section statement-protocol">
        ...
        <div class="blk">
            ...
            <div class="text">
                ...
                <br>
                <span class="statement-lineno">Next <var>nodeCount</var> lines</span>: <var>nodeId</var> <var>nodeX</var>
                <var>nodeY</var>, the id and location of each point
            </div>
            <br>
            <br>
